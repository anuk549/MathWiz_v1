...
class SubActivity : AppCompatActivity() {
        ...
        binding.apply {
            btnStartOrNext.setOnClickListener {
                try {
                    ...
                    Toast.makeText(this@SubActivity, "Error: ${e.message}", Toast.LENGTH_SHORT).show()
                }
            }
        ...
        binding.apply {
            ...
            btnEnter.setOnClickListener {
                try {
                    ...
                    if (userAnswer != null && answer >= 0 && userAnswer == answer) {
                        ...
                        if (answer < 0) {
                            Toast.makeText(this@SubActivity, "Answer cannot be negative, try again!", Toast.LENGTH_SHORT).show()
                        } else {
                            Toast.makeText(this@SubActivity, "Incorrect answer, try again!", Toast.LENGTH_SHORT).show()
                        }
                    }
                } catch (e: Exception) {
                    Toast.makeText(this@SubActivity, "Error: ${e.message}", Toast.LENGTH_SHORT).show()
    ...
    private fun getRandomNumbers() {
        ...
        secondRandomNumber = Random.nextInt(2, firstRandomNumber!!) // Ensures second number is less than first
    ...
    private fun showResultDialog() {
        if (!isFinishing) {
            ...
            dialogBinding.btnMenu.setOnClickListener {
                dialog.dismiss()
                val intent = Intent(this@SubActivity, MenuActivity::class.java)
